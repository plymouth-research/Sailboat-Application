...
thetaR = 0:0.1:2*pi;
thetaL = 0:0.1:2*pi;
thetaL(abs(wrapToPi(thetaL+pi/2-wind)) < range/2) = [];
thetaR(abs(wrapToPi(thetaR-pi/2-wind)) < range/2) = [];
...
sr1 = Osr+r*[cos(wind+range/2+pi/2), sin(wind+range/2+pi/2)];
sr2 = Osr+r*[cos(wind-range/2+pi/2), sin(wind-range/2+pi/2)];

sl1 = Osl+r*[cos(wind+range/2-pi/2), sin(wind+range/2-pi/2)];
sl2 = Osl+r*[cos(wind-range/2-pi/2), sin(wind-range/2-pi/2)];
...
pr1 = Ofr+r*[cos(wind+range/2+pi/2), sin(wind+range/2+pi/2)];
pr2 = Ofr+r*[cos(wind-range/2+pi/2), sin(wind-range/2+pi/2)];

pl1 = Ofl+r*[cos(wind+range/2-pi/2), sin(wind+range/2-pi/2)];
pl2 = Ofl+r*[cos(wind-range/2-pi/2), sin(wind-range/2-pi/2)];
